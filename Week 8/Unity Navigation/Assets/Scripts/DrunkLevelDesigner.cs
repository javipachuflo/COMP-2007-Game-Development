...
public class DrunkLevelDesigner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Transform tile = Instantiate(cellPrefab, position, Quaternion.identity, transform).transform;

            tile.localScale = new Vector3(cellSize, 0.1f, cellSize);
        }
